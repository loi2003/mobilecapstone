      ...
      <ScrollView contentContainerStyle={styles.scrollContent}>
        <View style={styles.section}>
          ...
          <Text style={styles.sectionDescription}>
            Connect with healthcare professionals for personalized advice and support.
          </Text>
          <TouchableOpacity
            style={styles.button}
            onPress={() => Linking.openURL('mailto:support@genderhealthweb.com')}
          >
            <Text style={styles.buttonText}>Email Us</Text>
          </TouchableOpacity>
          <TouchableOpacity
            style={styles.button}
            onPress={() => Linking.openURL('tel:(123)456-7890')}
          >
