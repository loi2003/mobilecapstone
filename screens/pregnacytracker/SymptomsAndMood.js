  ...
  return (
    <View style={styles(width).container}>
      ...
      <View style={styles(width).symptomsSection}>
        <Text style={styles(width).sectionSubtitle}>Check the symptom that fits your current state! (Optional)</Text>
              ...
              >
                <View style={[styles(width).checkmark, selectedIds.includes(idStr) ? styles(width).checkmarkSelected : {}]}>
                  {selectedIds.includes(idStr) && (
                    <View style={styles(width).checkmarkInner} />
                  )}
                </View>
        ...
        >
          <Ionicons name="add-circle-outline" size={16} color="#FE6B6A" />
        ...
        <View style={styles(width).popupOverlay}>
          <View style={styles(width).popupContainer}>
            ...
            <View style={styles(width).popupButtons}>
              ...
              >
                <Text style={styles(width).popupBtnText}>Cancel</Text>
              </TouchableOpacity>
            </View>
          </View>
        </View>
