...
export const homepageData = {
  ...
  resources: {
    title: "Resources for Expectant Mothers",
    description: "Explore articles, instructional videos, and helpful tools to support your pregnancy journey.",
    items: [
      {
        title: "Pregnancy Nutrition Guide",
        description: "Learn about sample meal plans and healthy eating tips for each trimester.",
        link: "/resources/nutrition-guide",
      },
      {
        title: "Yoga Exercise Videos",
        description: "Safe yoga routines for expectant mothers, guided by experts.",
        link: "/resources/yoga-videos",
      },
      {
        title: "Pregnancy FAQs",
        description: "Answers to common questions from obstetric specialists.",
        link: "/resources/faq",
      },
      {
        title: "40-Week Pregnancy Journey",
        description: "Detailed guide on your baby's development and care tips for each week.",
        link: "/resources/pregnancy-tracker",
      },
      {
        title: "Milestone Tracking Tool",
